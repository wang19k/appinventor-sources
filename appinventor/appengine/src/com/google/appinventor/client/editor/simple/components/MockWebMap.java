...
/**
 * Mock WebMap component.
 */
public final class MockWebMap extends MockVisibleComponent {

  /**
   * Component type name.
   */
  public static final String TYPE = "WebMap";
  ...
  private final Image largeImage = new Image(images.webmapbig());
   ...
   */
  public MockWebMap(SimpleEditor editor) {
    super(editor, TYPE, images.webmap());
