...
//Start updating all values to right of equal sign
    ...
    Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_COLLAPSED_SUFFIX = " nel'intervallo";
    Blockly.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP = "Esegui i blocchi nella sezione 'esegui' per ogni valore numerico nel'intervallo dal valore iniziale al valore finale, sommando ogni volta il valore indicato.  Usa il nome della variabile data per riferirti al valore attuale.";
    ...
    Blockly.Msg.LANG_CONTROLS_FOREACH_TOOLTIP = "Esegui i blocchi nella sezione 'esegui'  per ogni elemento nella lista.  Usa il nome della variabile data per riferirti all'elemento attuale della lista.";
Blockly.Msg.LANG_CONTROLS_GET_HELPURL = 'http://appinventor.mit.edu/explore/ai2/support/blocks/control#get';
    ...
    Blockly.Msg.LANG_CONTROLS_CHOOSE_TOOLTIP = "Se la condizione che stai testando è vera, restituisci come risultato il valore dell’espressione nell'argomento 'allora', altrimenti restituisci come risultato il valore dell’espressione dell'argomento 'altrimenti', al massimo una delle due espressioni sarà valutata.";
    ...
    Blockly.Msg.LANG_CONTROLS_EVAL_BUT_IGNORE_TOOLTIP = 'Esegui i blocchi connessi e ignora il risultato (se presente). Utile se hai bisogno di chiamare una procedura che restituisce un valore, ma non hai bisogno del valore di ritorno.';
...
Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_HELPURL = 'http://appinventor.mit.edu/explore/ai2/support/blocks/control#closescreen';
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_VALUE_TITLE = 'chiudi lo schermo con il valore';
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_PLAIN_TEXT_TITLE = 'chiudi schermo con il testo';
    ...
    Blockly.Msg.LANG_CONTROLS_CLOSE_SCREEN_WITH_PLAIN_TEXT_TOOLTIP = 'Chiude questo schermo e restituisce il testo all’app che lo ha aperto. Per app multischermo, usa "chiudi schermo con il valore" anziché "chiudi schermo con il testo".';
    ...
    Blockly.Msg.LANG_LOGIC_COMPARE_TOOLTIP_NEQ = 'Restituisci "vero" se entrambi i campi non sono uguali fra loro.';
    ...
    Blockly.Msg.LANG_LOGIC_OPERATION_TOOLTIP_AND = 'Restituisci "vero" se tutti i campi sono veri.';
    Blockly.Msg.LANG_LOGIC_OPERATION_TOOLTIP_OR = 'Restituisci "vero" se un qualsiasi campo è vero.';
    ...
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_EQ = 'Restituisci "vero" se entrambi i numeri sono uguali fra di loro.';
    Blockly.Msg.LANG_MATH_COMPARE_TOOLTIP_NEQ = 'Restituisci "vero" se i numeri non sono uguali fra di loro.';
    ...
    Blockly.Msg.LANG_MATH_SINGLE_TOOLTIP_LN = 'Riporta il logaritmo naturale di un numero, cioè il logaritmo in base e (2.71828...).';
...
Blockly.Msg.LANG_MATH_TRIG_HELPURL_TAN = 'http://appinventor.mit.edu/explore/ai2/support/blocks/math#tan';
    ...
    Blockly.Msg.LANG_MATH_FORMAT_AS_DECIMAL_INPUT = 'converti in numero decimale %1 con %2 decimali';
    ...
    Blockly.Msg.LANG_TEXT_SPLIT_AT_TOOLTIP = 'Divide il testo nei pezzi separati da spazi.';
    ...
    Blockly.Msg.LANG_TEXT_REPLACE_ALL_INPUT = 'sostituisce tutto il testo %1 rimpiazzando segmento %2 con %3';
...
Blockly.Msg.LANG_LISTS_IS_IN_HELPURL = 'http://appinventor.mit.edu/explore/ai2/support/blocks/lists#inlist';
    ...
    Blockly.Msg.LANG_LISTS_IS_IN_INPUT = "è nella lista? contenuto %1 lista %2    Blockly.Msg.LANG_LISTS_IS_IN_TOOLTIP = 'Restituisce vero se il contenuto è un elemento della lista, e falso se non lo è.";
Blockly.Msg.LANG_LISTS_POSITION_IN_HELPURL = 'http://appinventor.mit.edu/explore/ai2/support/blocks/lists#indexinlist';
    ...
    Blockly.Msg.LANG_LISTS_REPLACE_ITEM_TOOLTIP = 'Rimpiazza un elemento nella lista alla posizione specificata da indice.';
    ...
    Blockly.Msg.LANG_LISTS_REMOVE_ITEM_TOOLTIP = "Rimuove l'elemento nella lista alla posizione specificata da indice.";
    ...
    Blockly.Msg.LANG_VARIABLES_LOCAL_DECLARATION_TITLE_INIT = 'initializza variabile locale';
    ...
    Blockly.Msg.LANG_PROCEDURES_DOTHENRETURN_TOOLTIP = "Esegue i blocchi in 'esegui' e restituisce il risultato. Utile se è necessario eseguire una procedura prima di impostare il valore di una variabile.";
    ...
    Blockly.Msg.LANG_PROCEDURES_DEFRETURN_TOOLTIP = 'Procedura che restituisce un risultato di ritorno.';
    ...
    Blockly.Msg.REPL_SECONDS_ENSURE_RUNNING = " qualche secondo affinché sia tutto avviato.";
    ...
    Blockly.Msg.LANG_LOGIC_NEGATE_TOOLTIP = 'Restituisci "vero" se il campo inserito è falso.\n Restituisci "falso" se il campo inserito è vero.';
